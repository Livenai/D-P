...
public class GenAleatorios {
	...
	private static final int SEMILLA=1987;		//semilla de aleatorios (NO CAMBIAR) 
	...
	*/
	 ...
	 */
	public static int generarNumero(int limiteRango){ //metodod pare generar num aleatorios
		if (instancia == null) 
